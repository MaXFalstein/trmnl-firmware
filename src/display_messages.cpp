/**
 * System UI message screens for the e-paper (Wi-Fi, API, firmware, QA, etc.).
 *
 * Extracted from display.cpp (architecture-modules: panel HAL vs UI messages).
 * Panel driver / image decode remain in display.cpp.
 */

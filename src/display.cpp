...
#ifdef BB_EPAPER
// Used by display.cpp and display_messages.cpp for full/partial panel refresh
bool display_update_epaper(int refreshMode, bool wait, bool writePlane = false, uint8_t plane = PLANE_0);
bool display_update_epaper(int refreshMode, bool wait, bool writePlane, uint8_t plane)
{
#ifdef BOARD_SEEED_RETERMINAL_E1002

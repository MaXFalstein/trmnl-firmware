...
// goToSleep / goToSleepButtonOnly / config_gpio_for_lp / wifiErrorDeepSleep → sleep_session
static bool setClock(void);                          // clock synchronization
static float readBatteryVoltage(void);               // battery voltage reading
// Non-static: used by sleep_session before deep sleep
...
// Non-static: awake-time stats for sleep_session / API inputs
